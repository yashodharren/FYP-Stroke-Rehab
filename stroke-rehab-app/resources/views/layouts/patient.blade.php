...
<body class="bg-gray-50">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <div class="w-64 bg-gradient-to-b from-green-700 to-green-900 text-white shadow-lg overflow-y-auto">
            ...
            <nav class="mt-6">
                ...
                <div class="px-4 py-2">
                    <a href="{{ route('patient.appointments') }}"
                        class="flex items-center gap-3 px-4 py-3 rounded-lg transition
                       @if(request()->routeIs('patient.appointments')) bg-green-600 text-white @else text-green-100 hover:bg-green-600 @endif">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
