...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        <div class="mb-8 flex justify-between items-start">
            <div>
                <h1 class="text-4xl font-bold text-gray-900">Clinician Dashboard</h1>
                <p class="text-gray-600 mt-2">Welcome, {{ auth()->user()->name }}</p>
            </div>
            <div class="flex gap-3">
                <a href="{{ route('clinician.patients.index') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 font-medium">
                    View All Patients
                </a>
            </div>
        </div>
