...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-white border-t-4 border-t-blue-600 rounded-xl shadow p-5 flex items-center gap-4">
        ...
        <div class="bg-white border-t-4 border-t-green-500 rounded-xl shadow p-5 flex items-center gap-4">
        ...
        <div class="bg-white border-t-4 border-t-purple-600 rounded-xl shadow p-5 flex items-center gap-4">
        ...
        <div class="bg-white border-t-4 border-t-amber-500 rounded-xl shadow p-5 flex items-center gap-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        {{-- Weekly Adherence --}}
        <div class="bg-white border-t-4 border-t-blue-600 rounded-xl shadow p-6">
        ...
        <div class="bg-white border-t-4 border-t-blue-600 rounded-xl shadow p-6 lg:col-span-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow overflow-hidden">
            <div class="px-6 py-4 border-t-4 border-t-blue-600 flex items-center justify-between">
    ...
    <div class="bg-white rounded-xl shadow overflow-hidden mb-8">
        <div class="px-6 py-4 border-t-4 border-t-blue-600">
