...
<div class="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900">My Rehabilitation Plan</h1>
        ...
        @if($activePlan)
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">Upcoming Exercises</h2>
                </div>
                <div class="divide-y divide-gray-200">
                    @forelse($planExercises->take(5) as $planExercise)
                    ...
                    @empty
                        <div class="px-6 py-4 text-center text-gray-600">
                            No exercises assigned yet. Your clinician will add exercises to your plan.
                        </div>
                    @endforelse
                </div>
            </div>
